...
function Skills() {
  ...
  return (
    <>
      <div className="min-h-screen flex flex-col flex-wrap items-center css-about bg-center bg-cover bg-no-repeat justify-center items-center p-[3%]">
      ...
      <div className="min-h-screen flex flex-col flex-wrap  items-center p-[3%] bg-septenary w-[100%]">
        <div className="w-[100%] h-[100%] justify-center">
          <h1 className="text-white text-3xl text-center font-bold m-[3%]">
            {t("skillThree")}
          </h1>
        </div>
        <Cards2 />
